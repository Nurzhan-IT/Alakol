...
- Автоматическое разделение суммы 10% (предоплата онлайн) / 90% (оплата при заселении)
...
- Определение геолокации и устройства пользователя (`geoip2`, `django-user-agents`)
